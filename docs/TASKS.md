...
- [ ] **MCP-2 · Generated config has hardcoded DEV/DEMO paths → leaks founder identity.**
  The "Expose Prevail" snippet emits `command: /Users/you/Documents/fru/fd-apps/
  prevail-desktop/src-tauri/target/debug/prevail` (founder's dev tree) and `--vault
  /Users/you/Downloads/2026 June/vault-1-demo` (demo vault). For an INSTALLED user this is
