...
| `APPLE_SIGNING_IDENTITY` | `Developer ID Application: Fru (TXN399AHT5)` | Exact name of the cert |
...
1. In **Keychain Access**, find **Developer ID Application: Fru (TXN399AHT5)**.
