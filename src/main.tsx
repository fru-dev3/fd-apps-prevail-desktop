...
function showFatal(msg: string, err?: unknown) {
  ...
  if (el) {
    el.innerHTML =
      ...
      '<button onclick="location.reload()" style="padding:8px 18px;border-radius:8px;border:1px solid #008000;' +
      'background:#008000;color:#fff;font:600 13px ui-monospace,monospace;cursor:pointer;margin-bottom:18px">Reload Prevail</button>' +
